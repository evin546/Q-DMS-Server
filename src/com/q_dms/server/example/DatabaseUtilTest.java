...
public class DatabaseUtilTest {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        User user = new User("1234", "user1", "男");
        Timestamp timestamp = new Timestamp(System.currentTimeMillis());

        LogRec logRec = new LogRec(-1, timestamp, "四川", "11111", "十七", "192.168.2.2", "3", "-1");
        LogisticsRec logisticsRec = new LogisticsRec(-1, timestamp, "四川成都", "01111", "小五", "小六", "1", "-1");
